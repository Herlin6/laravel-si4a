                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="nama"
                            value="{{old('nama') ? old('nama') : $prodi->nama}}"
                        />
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="singkatan"
                            value="{{old('singkatan') ? old('singkatan') : $prodi->singkatan}}"
                        />
                        @error('singkatan')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="kaprodi"
                            value="{{old('kaprodi') ? old('kaprodi') : $prodi->kaprodi}}"
                        />
                        @error('kaprodi')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="sekretaris"
                            value="{{old('sekretaris') ? old('sekretaris') : $prodi->sekretaris}}"
                        />
                        @error('sekretaris')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
